export default function RandomCards(props){
    return(
        <div className="grid md:grid-cols-4 sm:grid-cols-7 grid-cols-9 lg:p-4 md:p-3 sm:p-2 p-1">
            ...
            <div className="md:p-2 sm:p-1 p-0 md:col-span-3 sm:col-span-5 col-span-5">
                ...
                <h3 className="text-white font-anta lg:text-2xl md:text-xl sm:text-lg text-md lg:pt-6 md:pt-5 sm:pt-4 pt-3 md:line-clamp-5 sm:line-clamp-4 line-clamp-3">{props.anime.desription}</h3>
            </div>
        </div>
    );
}