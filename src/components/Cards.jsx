export default function Cards(props){
    return(
        <div className="grid md:grid-cols-4 sm:grid-cols-7 grid-cols-9 lg:p-4 md:p-3 sm:p-2 p-1 transition-transform duration-200 ease-in-out hover:scale-[1.02] hover:bg-blue-950 rounded-lg">
            ...
            <div className="md:p-2 sm:p-1 p-0 md:col-span-3 sm:col-span-5 col-span-5">
                <h1 className="font-anta font-semibold truncate max-w-fit overflow-x-hidden lg:text-4xl md:text-3xl sm:text-2xl text-xl text-white hover:scale-105 transition-transform duration-200 ease-in-out">{props.anime.eng_title}</h1>
